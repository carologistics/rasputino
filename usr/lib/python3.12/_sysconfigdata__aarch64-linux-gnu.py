...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/usr/bin',
 'BINLIBDEST': '/usr/lib/aarch64-linux-gnu/python3.12',
 'BLDLIBRARY': '-lpython3.12',
 'BLDSHARED': 'aarch64-linux-gnu-gcc -shared -Wl,-O1 -Wl,-Bsymbolic-functions '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '-Wdate-time -D_FORTIFY_SOURCE=3 -g '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-Bsymbolic-functions '
                      ...
                      '-g -fwrapv -O2   '
                      '',
 'CONFIGURE_LDFLAGS_NODIST': '-Wl,-Bsymbolic-functions '
                             ' '
                             '-Wl,-z,relro -g -fwrapv -O2  '
                             ' ',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/usr' "
                "'--libdir=/usr/lib/aarch64-linux-gnu' '--enable-ipv6' "
                ...
                "'MKDIR_P=/bin/mkdir -p' 'CC=aarch64-linux-gnu-gcc'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/python3.12-gbj2PD/python3.12-3.12.3/build-shared/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/python3.12-gbj2PD/python3.12-3.12.3/build-shared/lcov-report',
 ...
 'DESTDIRS': '/usr /usr/lib/aarch64-linux-gnu '
             '/usr/lib/aarch64-linux-gnu/python3.12 '
 ...
 'INCLDIRSTOMAKE': '/usr/include /usr/include /usr/include/python3.12 '
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'aarch64-linux-gnu-g++ -shared -Wl,-O1 '
                '-Wl,-Bsymbolic-functions',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'aarch64-linux-gnu-gcc -shared -Wl,-O1 -Wl,-Bsymbolic-functions '
             '-Wl,-Bsymbolic-functions '
             ' -Wl,-z,relro -g -fwrapv '
             '-O2   ',
 'LDVERSION': '3.12',
 ...
 'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall '
                    '-Wdate-time -D_FORTIFY_SOURCE=3 -g '
                    '-fno-omit-frame-pointer -mno-omit-leaf-frame-pointer '
                    ' '
                    ' '
                    '-fstack-protector -fstack-clash-protection -Wformat '
                    ...
                    '-IInclude -IPython -I. -I../Include -fPIC -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBHACL_CFLAGS': '-I../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE '
                   '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall '
                   '-Wdate-time -D_FORTIFY_SOURCE=3 -g -fno-omit-frame-pointer '
                   '-mno-omit-leaf-frame-pointer '
                   ' '
                   ' '
                   '-fstack-protector -fstack-clash-protection -Wformat '
 ...
 'LIBMPDEC_CFLAGS': '-I../Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 '
                    ...
                    '-DNDEBUG -g -O2 -Wall -Wdate-time -D_FORTIFY_SOURCE=3 -g '
                    '-fno-omit-frame-pointer -mno-omit-leaf-frame-pointer '
                    ' '
                    ' '
                    '-fstack-protector -fstack-clash-protection -Wformat '
 ...
 'LIBPL': '/usr/lib/python3.12/config-3.12-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/lib/aarch64-linux-gnu/python3.12',
 ...
 'MODBUILT_NAMES': '_bisect  _csv  _datetime  _heapq  _opcode  _pickle  '
                   ...
                   '_sha1  _sha2  _sha3  unicodedata  _posixsubprocess  fcntl  '
                   'grp  spwd  syslog  zlib  atexit  faulthandler  posix  '
                   ...
                   '_asyncio  _contextvars  _json  _lsprof  _queue  '
                   '_xxsubinterpreters  _xxinterpchannels  _zoneinfo  audioop  '
                   '_decimal  _bz2  _lzma  _dbm  _gdbm  readline  _codecs_cn  '
                   '_codecs_hk  _codecs_iso2022  _codecs_jp  _codecs_kr  '
                   '_codecs_tw  _multibytecodec  _crypt  mmap  ossaudiodev  '
                   'resource  termios  _posixshmem  _multiprocessing  _ctypes  '
                   '_curses  _curses_panel  _sqlite3  _ssl  _hashlib  '
 ...
 'MODOBJS': 'Modules/_bisectmodule.o  Modules/_csv.o  '
            ...
            'Modules/_hacl/Hacl_Hash_SHA3.o  Modules/unicodedata.o  '
            ...
            'Modules/pwdmodule.o',
 'MODSHARED_NAMES': '_asyncio _contextvars _json _lsprof _queue '
                    '_xxsubinterpreters _xxinterpchannels _zoneinfo audioop '
                    '_decimal _bz2 _lzma _dbm _gdbm readline _codecs_cn '
                    '_codecs_hk _codecs_iso2022 _codecs_jp _codecs_kr '
                    '_codecs_tw _multibytecodec _crypt mmap ossaudiodev '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g '
                             '-O2 -Wall -Wdate-time -D_FORTIFY_SOURCE=3 -g '
                             '-fno-omit-frame-pointer '
                             '-mno-omit-leaf-frame-pointer '
                             ' '
                             ' '
 ...
 'PY_CFLAGS_NODIST': '-Wdate-time -D_FORTIFY_SOURCE=3 -g '
                     '-fno-omit-frame-pointer -mno-omit-leaf-frame-pointer '
                     ' '
                     ' '
                     '-fstack-protector -fstack-clash-protection -Wformat '
 ...
 'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall '
                   '-Wdate-time -D_FORTIFY_SOURCE=3 -g -fno-omit-frame-pointer '
                   '-mno-omit-leaf-frame-pointer '
                   ' '
                   ' '
 ...
 'PY_LDFLAGS': '-Wl,-Bsymbolic-functions '
               ' -Wl,-z,relro -g '
               '-fwrapv -O2   ',
 'PY_LDFLAGS_NODIST': '-Wl,-Bsymbolic-functions '
                      ' -Wl,-z,relro '
                      '-g -fwrapv -O2   '
                      '',
 'PY_LDFLAGS_NOLTO': '-Wl,-Bsymbolic-functions '
                     ' -Wl,-z,relro -g '
                     '-fwrapv -O2   ',
 ...
 'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 '
                        '-Wall -Wdate-time -D_FORTIFY_SOURCE=3 -g '
                        '-fno-omit-frame-pointer -mno-omit-leaf-frame-pointer '
                        ' '
                        ' '
                        '-fstack-protector -fstack-clash-protection -Wformat '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python3.12-gbj2PD/python3.12-3.12.3/build-shared',
 'SCRIPTDIR': '/usr/lib',
 'SCRIPT_2TO3': 'build/scripts-3.12/2to3-3.12',
 'SCRIPT_IDLE': 'build/scripts-3.12/idle3.12',
 'SCRIPT_PYDOC': 'build/scripts-3.12/pydoc3.12',
 'SETPGRP_HAVE_ARG': 0,
 'SHAREDMODS': 'Modules/_asyncio.cpython-312-aarch64-linux-gnu.so '
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python3.12-gbj2PD/python3.12-3.12.3/build-shared '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/python3.12-gbj2PD/python3.12-3.12.3/build-shared '
 ...
 'abs_builddir': '/build/python3.12-gbj2PD/python3.12-3.12.3/build-shared',
 'abs_srcdir': '/build/python3.12-gbj2PD/python3.12-3.12.3/build-shared/..',
