...
constexpr PixelFormat RGGB16_PISP_COMP1{ __fourcc('R', 'G', 'B', '6'), __mod(12, 1) };
constexpr PixelFormat GRBG16_PISP_COMP1{ __fourcc('G', 'R', '1', '6'), __mod(12, 1) };
constexpr PixelFormat GBRG16_PISP_COMP1{ __fourcc('G', 'B', '1', '6'), __mod(12, 1) };
constexpr PixelFormat BGGR16_PISP_COMP1{ __fourcc('B', 'Y', 'R', '2'), __mod(12, 1) };
constexpr PixelFormat MONO_PISP_COMP1{ __fourcc('R', '1', '6', ' '), __mod(12, 1) };
constexpr PixelFormat PISP_VERIFICATION{ __fourcc('B', 'Y', 'R', '2'), __mod(12, 3) };
